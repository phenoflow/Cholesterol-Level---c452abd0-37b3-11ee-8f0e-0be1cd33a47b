...
(async () => {
  ...
  await fs.writeFile("cholesterol-level-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("cholesterol-level-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
